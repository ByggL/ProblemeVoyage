...
def Lecture_Fichier():
    ...
    if TSP.readline() == "NODE_COORD_SECTION":
        Type1() # Faire appel à une fonction pour le type de Fichier qui ressemble à att48.tsp
    else:
        Type2() # Faire appel à une fonction pour le type de Fichier comme bayg29.tsp
